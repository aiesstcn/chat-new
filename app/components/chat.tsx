...
export function Chat() {
  ...
  return (
    <div className={styles.chat} key={session.id}>
          ...
          return (
            ...
            >
              <div className={styles["chat-message-container"]}>
                ...
                {!isUser && (
                  <div className={styles["chat-message-client-ip"]}></div>
                )}
                {!isUser && !message.preview && (
                  <div className={styles["chat-message-actions"]}>
                    <div className={styles["chat-message-action-date"]}>
                      <div className={styles["chat-message-client-ip"]}>
                        <div
                          className={styles["chat-message-client-dot"]}
                        ></div>
                        {clientIp}
                      </div>
      ...
      <div className={styles["chat-input-panel-issue"]}>
        声明：本平台仅作为学习研究，严禁发表违背国家法律的言论.
      </div>
    </div>
  );
}
